        ...
        <div class="row justify-content-start ">
            <div class="col breadcrumb_col">
                <nav style="" aria-label="breadcrumb" class="pl-0 py-0">
                    ...
                    <li id="breadcrumb_active" class="breadcrumb-item active" aria-current="page">Search</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-12 order-1 order-sm-2">
                ...
                <div class="row mt-2 justify-content-between">
                    ...
                    <div class="col-lg-6 col-12 mb-3">
                        <div class="row">
                            <div class="col-8 col-sm-9 pr-0 pr-sm-1 pr-md-3 col-md-12 ">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <div class="dropdown">	
                                ...
                                <ul id="sort_options" class="dropdown-menu body-text" aria-labelledby="dropdownMenuButton">
                                    @if ($sortedBy == 'productNameAsc'  || $sortedBy == 'productNameDesc' )
                                        <li><a class="dropdown-item" href="{{ route('products.searchSort', ['current_search' => $current_search, 'sortBy' =>'product_name','order' =>'asc']) }}" >A to Z</a></li>
                                        <li><a class="dropdown-item" href="{{ route('products.searchSort', ['current_search' => $current_search, 'sortBy' =>'product_name','order' =>'desc']) }}" >Z to A</a></li>
                                    @elseif ($sortedBy == 'productPriceAsc'  || $sortedBy == 'productPriceDesc' )
                                        <li><a class="dropdown-item" href="{{ route('products.searchSort', ['current_search' => $current_search, 'sortBy' =>'product_price','order' =>'asc']) }}">Low to High</a> </li> 
                                        <li><a class="dropdown-item" href="{{ route('products.searchSort', ['current_search' => $current_search, 'sortBy' =>'product_price','order' =>'desc']) }}">High to Low</a></li>
                                    @endif
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        <hgroup class="">
                            ...
                            <h2 class="lead heading-text"><strong style="color: #4b922d;">{{count($products)}}</strong> Result(s) were Found for the Word "<strong style="color: #4b922d;">{{$current_search}}</strong>" </h2>								
                        </hgroup>                    
                    </div>
                </div>
